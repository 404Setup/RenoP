...
const baseIcons = Object.freeze({
    ...
    repositoryConda: strokeIcon('<path d="M19 6a8 8 0 1 0 1 10M19 6v5h-5"/><circle cx="8" cy="12" r="1"/><path d="M8 16h5"/>', 20, 1.8),
    repositoryConan: strokeIcon('<path d="m12 3 8 4v10l-8 4-8-4V7Z"/><path d="m4 7 8 4 8-4M12 11v10M10 8H8v5h2M14 8h2v5h-2"/>', 20, 1.8),
    repositoryCondaNative: strokeIcon('<path d="m12 3 8 4v10l-8 4-8-4V7Z"/><path d="m4 7 8 4 8-4M12 11v10M9 6l8 4"/>', 20, 1.8),
    repositoryApk: strokeIcon('<path d="m2 19 7-13 5 8 3-5 5 10Z"/><path d="m6 12 3 2 3-3"/>', 20, 1.8),
    repositoryApt: strokeIcon('<path d="M14 12a3 3 0 1 1-3-3 5 5 0 1 1-5 5 7 7 0 1 1 11 6"/>', 20, 1.8),
    repositoryRpm: strokeIcon('<path d="m12 3 8 5v8l-8 5-8-5V8Z"/><path d="M8 16V8h4a3 3 0 0 1 0 6H8m4 0 4 3"/>', 20, 1.8),
