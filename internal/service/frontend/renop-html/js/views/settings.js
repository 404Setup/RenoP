    ...
    return el("div", {"class": "tab-content", "id": "tab-content-settings", "style": "display: none;"},
        el("div", {"class": "settings-header"},
            el("div", {},
                ...
                el("p", {
                    "class": "settings-propagation",
                    "data-i18n": "settings.propagationNotice"
                }, "Listener, database, and cache backend changes require a restart.")
            )
        ),
        el("div", {"class": "settings-workspace"},
            ...
            el("div", {"class": "settings-main"},
                ...
                el("nav", {
                    "id": "settings-subnav",
                    "data-i18n-aria-label": "settings.sections",
                ...
                el("div", {"class": "settings-page-header"},
                    ...
                    el("div", {"class": "settings-actions"},
                        el("button", {
                                ...
                                "data-i18n-title": "settings.restartBtnTitle",
                                "id": "settings-restart-btn",
                                "title": "Restart the Renop service",
                                "type": "button"
                            },
                            svg("svg", {
                                    "aria-hidden": "true",
                        ...
                        el("button", {
                                ...
                                "data-i18n-title": "settings.saveBtnTitle",
                                "disabled": true,
                                "id": "settings-save-btn",
                                "title": "Save changes and reload configuration",
                                "type": "button"
                            },
                            svg("svg", {
                                    "aria-hidden": "true",
                ...
                el("div", {
                    ...
                    "class": "cfg-page-content",
                    "id": "settings-form-container",
                    "role": "region"
                }),
                el("nav", {
                    "aria-label": "Settings pages",
                    "class": "renop-pagination",
                    "data-i18n-aria-label": "settings.sections",
