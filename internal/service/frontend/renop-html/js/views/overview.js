...
export function renderOverview() {
    return el("div", {"class": "tab-content", "id": "tab-content-overview"},
            ...
            el("div", {"class": "col-left"},
                el("div", {"class": "browser-header"},
                    el("nav", {"aria-label": "Directory path", "class": "breadcrumb-nav", "id": "breadcrumb"},
                        ...
                        el("a", {
                                ...
                                "class": "up-dir",
                                "data-i18n-aria-label": "browser.upDirectory",
                                "data-i18n-title": "browser.upDirectory",
                                "href": "..",
                                "id": "up-dir-btn",
                    ...
                    el("form", {
                        ...
                        el("button", {
                                ...
                                "data-i18n-aria-label": "search.clear",
                                "hidden": true,
                                "id": "repository-search-clear",
                                "type": "button"
                            },
                            svg("svg", {
                                    "aria-hidden": "true",
                    ...
                    el("div", {"class": "browser-adjustments"},
                        el("button", {
                                "aria-controls": "adjustments-menu",
                                "aria-expanded": "false",
                                "aria-haspopup": "true",
                                "class": "adjustments-trigger-btn",
                                "data-i18n-title": "browser.adjustments",
                                "id": "adjustments-btn",
                                "title": "Adjustments",
                                "type": "button"
                            },
                        ...
                        el("div", {"aria-hidden": "true", "class": "adjustments-panel", "id": "adjustments-menu"},
                            el("div", {"class": "adjustments-panel-header"},
                                ...
                                el("span", {
                                    "class": "adjustments-panel-title",
                                    "data-i18n": "browser.fileBrowser"
                                }, "File Browser")
                            ),
                            el("div", {"class": "adjustments-panel-body"},
                                el("div", {"class": "adjustments-row"},
                                    el("div", {"class": "adjustments-row-text"},
                                        el("span", {
                                            "class": "adjustments-row-label",
                                            "data-i18n": "browser.sortNewest"
                                        }, "Sort newest first"),
                                        el("span", {
                                            "class": "adjustments-row-desc",
                                            "data-i18n": "browser.sortNewestDesc"
                                ...
                                el("div", {"class": "adjustments-row"},
                                    el("div", {"class": "adjustments-row-text"},
                                        el("span", {
                                            "class": "adjustments-row-label",
                                            "data-i18n": "browser.showUtilityFiles"
                                        }, "Show utility files"),
                                        el("span", {
                                            "class": "adjustments-row-desc",
                                            "data-i18n": "browser.showUtilityFilesDesc"
                                        }, "Display checksums and metadata files")
                                    ),
                                    el("label", {"class": "adj-toggle"},
                ...
                el("div", {"class": "file-list-container", "id": "file-list-container"},
                    el("div", {"class": "file-list-viewport"},
                        ...
                        el("div", {
                            "class": "file-list-state",
                            "data-i18n": "browser.emptyState",
                            "hidden": true,
                            "id": "empty-state"
                        }, " Directory is empty "),
                        el("div", {
                            "class": "file-list-state file-list-state--error",
                            "data-i18n": "browser.errorState",
                            "hidden": true,
                            "id": "error-state"
                        }, "Directory not found ")
                    )
                ...
                el("div", {"class": "upload-panel", "hidden": true, "id": "upload-zone-container"},
                    el("div", {
                            ...
                            "data-i18n-aria-label": "browser.uploadZoneAria",
                            "id": "upload-zone",
                            "role": "button",
                            "tabindex": "0"
                        },
                        ...
                        el("div", {"class": "upload-dropzone-text"},
                            el("p", {
                                "class": "upload-dropzone-title",
                                "data-i18n": "browser.uploadTitle"
                            }, "Drop files to upload"),
                            el("p", {"class": "upload-dropzone-hint"},
                                el("span", {"data-i18n": "browser.uploadHintOr"}, "or"),
                                el("span", {
                                    "class": "upload-dropzone-browse",
                                    "data-i18n": "browser.uploadHintBrowse"
                                }, "browse"),
                            ...
                            el("div", {"class": "upload-controls-card"},
                                el("div", {"class": "upload-files-header"},
                                    el("div", {"class": "upload-files-header-left"},
                                        el("span", {
                                            "class": "upload-files-title",
                                            "data-i18n": "browser.selectedFiles"
                                        }, "Selected files"),
                                    ...
                                    el("button", {
                                        ...
                                        "data-i18n": "browser.clearAll",
                                        "id": "upload-clear-btn",
                                        "type": "button"
                                    }, "Clear all ")
                                ),
                                el("div", {
                                        "class": "upload-batch-progress-container",
                                        "id": "upload-batch-progress-container",
                                        "style": "display: none;"
                                    },
                                    el("div", {"class": "upload-batch-progress-info"},
                                        el("span", {
                                            "class": "upload-batch-progress-text",
                                            "id": "upload-batch-progress-text"
                                        }),
                                        el("span", {
                                            "class": "upload-batch-progress-percent",
                                            "id": "upload-batch-progress-percent"
                                        })
                                    ),
                                    el("div", {"class": "upload-batch-progress-bar"},
                                        el("div", {
                                            "class": "upload-batch-progress-fill",
                                            "id": "upload-batch-progress-fill"
                                        })
                                    )
                                ),
                                ...
                                el("div", {"class": "upload-options"},
                                    el("label", {"class": "upload-option"},
                                        ...
                                        el("span", {"class": "upload-option-text"},
                                            el("span", {
                                                "class": "upload-option-label",
                                                "data-i18n": "browser.genChecksums"
                                            }, "Generate checksums"),
                                            el("span", {
                                                "class": "upload-option-desc",
                                                "data-i18n": "browser.genChecksumsDesc"
                                            }, "Create MD5, SHA-1, SHA-256 and SHA-512 sidecars")
                                        )
                                    ),
                                    el("label", {"class": "upload-option"},
                                        el("span", {"class": "switch"},
                                        ...
                                        el("span", {"class": "upload-option-text"},
                                            el("span", {
                                                "class": "upload-option-label",
                                                "data-i18n": "browser.genPom"
                                            }, "Generate stub POM"),
                                            el("span", {
                                                "class": "upload-option-desc",
                                                "data-i18n": "browser.genPomDesc"
                                            }, "Write a minimal Maven POM for the uploaded artifact")
                                        )
                                    )
                                ),
                                        ...
                                        el("div", {"class": "pom-form-card"},
                                            el("div", {"class": "pom-form-grid"},
                                                el("div", {"class": "form-group"},
                                                    el("label", {
                                                        "data-i18n": "browser.pomGroup",
                                                        "for": "pom-group-id"
                                                    }, "Group"),
                                                    el("input", {
                                                        "autocomplete": "off",
                                                        "data-i18n-placeholder": "browser.pomGroupPlaceholder",
                                                        "id": "pom-group-id",
                                                ...
                                                el("div", {"class": "form-group"},
                                                    el("label", {
                                                        "data-i18n": "browser.pomArtifact",
                                                        "for": "pom-artifact-id"
                                                    }, "Artifact"),
                                                    el("input", {
                                                        "autocomplete": "off",
                                                        "data-i18n-placeholder": "browser.pomArtifactPlaceholder",
                                                        "id": "pom-artifact-id",
                                                        "placeholder": "my-app",
                                                        "type": "text"
                                                    })
                                                ...
                                                el("div", {"class": "form-group"},
                                                    el("label", {
                                                        "data-i18n": "browser.pomVersion",
                                                        "for": "pom-version"
                                                    }, "Version"),
                                                    el("input", {
                                                        "autocomplete": "off",
                                                        "data-i18n-placeholder": "browser.pomVersionPlaceholder",
                                                        "id": "pom-version",
                                                        "placeholder": "1.0.0",
                                                        "type": "text"
                                                    })
                                ...
                                el("div", {"class": "upload-footer"},
                                    el("div", {"class": "upload-destination-field"},
                                        el("label", {
                                            "data-i18n": "browser.uploadDest",
                                            "for": "upload-destination"
                                        }, "Destination"),
                                        el("input", {
                                            "autocomplete": "off",
                                            "data-i18n-placeholder": "browser.uploadDestPlaceholder",
                                            "id": "upload-destination",
                                            "placeholder": "repository/path/to/upload",
                                            "type": "text"
                                        })
                                    ),
                                    el("button", {
                                            "class": "pill-btn pill-btn--primary upload-submit-btn",
                                            "id": "upload-btn",
                                            "type": "button"
                                        },
                                        svg("svg", {
                                        ...
                                        el("span", {
                                            ...
                                            "data-i18n": "browser.uploadFilesBtn"
                                        }, "Upload files")
                                    )
                                )
                            )
                ...
                el("div", {"class": "details-card", "id": "repo-snippets-card", "style": "display: none;"},
                    el("div", {"class": "details-card-header"},
                        ...
                        el("div", {"class": "details-card-meta"},
                            ...
                            el("p", {
                                "class": "details-card-subtitle",
                                "data-i18n": "details.subtitle",
                                "id": "details-card-subtitle"
                            }, "Copy configuration snippets for your build tool")
                        ),
                        el("button", {
                                "class": "copy-btn",
                                "data-i18n-title": "details.copySnippet",
                                "id": "copy-snippet-btn",
                                "title": "Copy snippet"
                            },
                            svg("svg", {
                ...
                el("div", {"class": "details-card repo-stats-card", "id": "repo-stats-card", "style": "display: none;"},
                    el("div", {"class": "details-card-header"},
                        ...
                        el("div", {"class": "details-card-meta"},
                            el("h3", {
                                "class": "details-card-title",
                                "data-i18n": "details.statsTitle"
                            }, "Repository Storage & Mirrors"),
                            el("p", {
                                "class": "details-card-subtitle",
                                "data-i18n": "details.statsSubtitle"
                            }, "Local storage usage and configured mirrors")
                        )
                    ),
