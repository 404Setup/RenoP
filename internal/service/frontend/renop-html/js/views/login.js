...
export function renderLogin() {
    return el("section", {"aria-labelledby": "login-title", "class": "tab-content", "id": "tab-content-login", "style": "display: none;"},
        el("div", {"class": "account-page"},
            ...
            el("form", {"class": "account-page-form", "id": "login-form"},
                el("div", {"class": "account-field"},
                    ...
                    el("input", {"autocomplete": "username", "data-i18n-placeholder": "login.usernamePlaceholder", "id": "username", "maxlength": "254", "placeholder": "Enter username or private email", "required": true, "type": "text"})
                ),
                el("div", {"class": "account-field"},
                    el("label", {"data-i18n": "login.passwordLabel", "for": "password"}, "Password"),
                    el("input", {"autocomplete": "current-password", "data-i18n-placeholder": "login.passwordPlaceholder", "id": "password", "maxlength": "72", "placeholder": "Enter password", "required": true, "type": "password"})
                ),
                el("div", {"class": "account-form-error", "id": "login-error", "role": "alert", "style": "display: none;"}),
                el("div", {"class": "account-form-links"},
                    ...
                    el("a", {"class": "account-form-link", "data-i18n": "login.recoveryTitle", "href": "/account/recovery", "id": "btn-recover-account"}, "Recover account"),
                    el("a", {"class": "account-form-link", "data-i18n": "registration.title", "data-registration-link": true, "hidden": true, "href": "/account/register"}, "Create account")
                ),
                ...
                el("div", {"class": "account-providers"},
                    ...
                    el("button", {"class": "account-provider", "id": "btn-fido-login", "type": "button"},
                        svg("svg", {"aria-hidden": "true", "fill": "none", "stroke": "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", "viewBox": "0 0 24 24"},
            ...
            el("form", {"aria-labelledby": "mfa-login-title", "class": "account-page-form", "hidden": true, "id": "mfa-login-form"},
                ...
                el("div", {"class": "account-field", "id": "mfa-login-totp"},
                    ...
                    el("input", {"aria-describedby": "mfa-login-error", "autocomplete": "one-time-code", "id": "mfa-login-code", "inputmode": "numeric", "maxlength": "6", "minlength": "6", "pattern": "[0-9]{6}", "required": true, "type": "text"})
                ),
                el("p", {"class": "account-form-error", "hidden": true, "id": "mfa-login-error", "role": "alert"}),
                el("button", {"class": "account-submit", "data-i18n": "mfa.verify", "id": "mfa-login-submit", "type": "submit"}, "Verify "),
                el("button", {"class": "account-provider", "data-i18n": "mfa.usePasskey", "id": "mfa-login-passkey", "type": "button"}, " Verify with Passkey "),
                el("div", {"class": "account-form-links"},
                    el("button", {"class": "account-form-link", "data-i18n": "mfa.restart", "id": "mfa-login-restart", "type": "button"}, " Start again "),
                    el("a", {"class": "account-form-link", "data-i18n": "login.recoveryTitle", "href": "/account/recovery"}, "Recover account")
                )
            )
        )
    );
