    ...
    return el("div", {"class": "tab-content", "id": "tab-content-dashboard", "style": "display: none;"},
        el("div", {"class": "dashboard-hero"},
            el("div", {"class": "dashboard-hero-text"},
                ...
                el("p", {"class": "dashboard-subtitle", "data-i18n": "dashboard.subtitle"}, "Real-time metrics for your Renop instance")
            ),
            el("button", {"class": "pill-btn manager-only", "data-i18n": "audit.globalTitle", "id": "btn-dashboard-logs", "type": "button"}, "Global logs "),
            el("div", {"class": "dashboard-status-dot", "data-i18n-title": "dashboard.healthy", "id": "dashboard-status-indicator", "title": "Instance healthy"})
        ),
        el("div", {"class": "dashboard-cards"},
            el("div", {"class": "dashboard-card dashboard-card--version"},
                ...
                el("div", {"class": "dashboard-card-body"},
                    ...
                    el("div", {"class": "dashboard-card-value", "style": "display:flex; flex-direction:column; align-items:flex-start; gap:0.25rem;"},
                        el("a", {"href": "https://github.com/404Setup/RenoP", "id": "dashboard-version", "target": "_blank"}, "..."),
                        el("button", {"class": "pill-btn pill-btn--soft pill-btn--sm manager-only", "data-i18n": "dashboard.checkUpdate", "id": "btn-dashboard-update", "style": "padding: 0.2rem 0.6rem; font-size: 0.75rem;", "type": "button"}, "Check for Updates ")
                    )
                )
            ),
            ...
            el("div", {"class": "dashboard-chart-card"},
                ...
                el("div", {"class": "dashboard-chart-legend"},
                    el("span", {"class": "dashboard-chart-legend-item"},
                        el("span", {"aria-hidden": "true", "class": "dashboard-chart-legend-swatch dashboard-chart-legend-swatch--rss"}),
                        el("span", {"data-i18n": "dashboard.chartLegendRss"}, "RSS (resident)")
                    ),
                    el("span", {"class": "dashboard-chart-legend-item"},
                        el("span", {"aria-hidden": "true", "class": "dashboard-chart-legend-swatch dashboard-chart-legend-swatch--vss"}),
        ...
        el("div", {"class": "dashboard-section dashboard-debug-section", "hidden": true, "id": "dashboard-debug-tools"},
            el("div", {"class": "dashboard-section-header"},
                ...
                el("span", {"class": "dashboard-section-badge dashboard-section-badge--debug", "data-i18n": "dashboard.debugBadge"}, "Debug")
            ),
            el("div", {"class": "dashboard-debug-card"},
                el("p", {"class": "dashboard-debug-hint", "data-i18n": "dashboard.debugMemoryHint"}, " Download a full Go heap profile (pprof) for flame-graph analysis. Open with Speedscope or go tool pprof. "),
                el("div", {"class": "dashboard-debug-actions"},
                    el("button", {"class": "pill-btn pill-btn--soft", "data-i18n": "dashboard.dumpHeap", "id": "btn-dump-heap", "type": "button"}, " Dump heap flamegraph "),
                    el("button", {"class": "pill-btn pill-btn--soft", "data-i18n": "dashboard.dumpAllocs", "id": "btn-dump-allocs", "type": "button"}, " Dump allocs profile "),
                    el("button", {"class": "pill-btn pill-btn--soft", "data-i18n": "dashboard.dumpGoroutine", "id": "btn-dump-goroutine", "type": "button"}, " Dump goroutines ")
                )
            )
        )
    );
