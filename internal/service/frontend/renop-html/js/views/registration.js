            ...
            el("form", {"class": "account-page-form", "id": "registration-form"},
                ...
                el("fieldset", {"class": "account-reset-fields", "disabled": true, "id": "registration-fields"},
                    ...
                    el("div", {"class": "account-field"},
                        ...
                        el("input", {
                            "aria-describedby": "registration-username-hint",
                        ...
                        el("p", {
                            "data-i18n": "registration.usernameHint",
                            "id": "registration-username-hint"
                        }, "4–18 letters, numbers, or underscores.")
                    ),
                    el("div", {"class": "account-field"},
                        el("label", {
                            "data-i18n": "registration.nickname",
                            "for": "registration-nickname"
                        }, "Nickname (optional)"),
                        el("input", {
