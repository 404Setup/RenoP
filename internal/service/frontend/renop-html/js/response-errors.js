...
const commonErrorCodeKeys = Object.freeze({
    ...
    demo_read_only: 'demo.readOnly',
    demo_file_unavailable: 'demo.filesUnavailable',
    repository_capacity_exceeded: 'repos.capacityExceeded',
    ACCOUNT_SECURITY_HOLD: 'profile.securityHold',
